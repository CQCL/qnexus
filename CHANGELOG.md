...
- Experimental workflow for executing HUGR jobs.
...
- Default postprocess to false. (#145).
...
- Correct serialization of status enum (#81).
...
- Cancel and retry api incompat (#79).
...
- Add h series noise model (#33).
- Restore some cli functionality (#28).
- Refactor to support python 3.10.
- Refactor to support python 3.10.
...
- Allow querying by properties (#22).
- Allow job properties to be passed (#21).
- First pass at properties contexts.
- First pass at properties contexts.
